function varargout = fingerprint_featurevector(varargin)
% FINGERPRINT_FEATUREVECTOR MATLAB code for fingerprint_featurevector.fig
%      FINGERPRINT_FEATUREVECTOR, by itself, creates a new FINGERPRINT_FEATUREVECTOR or raises the existing
%      singleton*.
%
%      H = FINGERPRINT_FEATUREVECTOR returns the handle to a new FINGERPRINT_FEATUREVECTOR or the handle to
%      the existing singleton*.
%
%      FINGERPRINT_FEATUREVECTOR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FINGERPRINT_FEATUREVECTOR.M with the given input arguments.
%
%      FINGERPRINT_FEATUREVECTOR('Property','Value',...) creates a new FINGERPRINT_FEATUREVECTOR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fingerprint_featurevector_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fingerprint_featurevector_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fingerprint_featurevector

% Last Modified by GUIDE v2.5 06-Oct-2014 18:34:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fingerprint_featurevector_OpeningFcn, ...
                   'gui_OutputFcn',  @fingerprint_featurevector_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fingerprint_featurevector is made visible.
function fingerprint_featurevector_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fingerprint_featurevector (see VARARGIN)

% Choose default command line output for fingerprint_featurevector
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes fingerprint_featurevector wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fingerprint_featurevector_OutputFcn(hObject, eventdata, handles) 
...
filtered_1 = imfilter(In1,h);
axes(handles.axes1)
imshow(filtered_1),title('FILTERED FINGERPRINT');
...
data = [MSE1;PSNR1;NK1;AD1;SC1;MD1;NAE1;snr1;LMSE1;RAMD1;MAS1;MAMS1;TED1;TCD1;SME1;SPE1;mssim1;vif1;rred1;HLFI1;BIQI1;mea;NIQE1;m5;m6]/100;
data = sum(data)
% data_fin6 = sum(data)
% save data_fin6 data_fin6
